...
<body>
    ...
    <div class="container mt-4">
        <h2 class="text-center mb-4">Daftar Data Transaksi</h2>
        <a href="{{ route('transaksi.inputData') }}" class="btn btn-success mb-3">Tambah Transaksi</a>
        <table class="table">
            <thead>
                <tr>
                    <th>No.</th>
            ...
            <tbody>
                @foreach($barangnota as $key => $item)
                    <tr>
                        <td>{{ $key + 1 }}</td>
                        <td>{{ $item->KodeNota }}</td>
                        ...
                        <td>{{ $item->Jumlah }}</td>
                        <td>
                            <a href="{{ route('transaksi.form-update', ['id' => $item->KodeBarang]) }}" class="btn btn-warning">Edit</a>
